...
int main(int argc, char ** argv){
    ...
    alarm(5); // se il server non trova nulla all'interno della coda
              // entro 5 secondi il processo si blocca
    ...
    printf("(PID=%d): Q_id=%d: msg type=%ld \"%s\" RECEIVED\n",
	       getpid(), q_id, my_msg.mtype, my_msg.mtext); // stampa messaggio rimosso dalla coda
